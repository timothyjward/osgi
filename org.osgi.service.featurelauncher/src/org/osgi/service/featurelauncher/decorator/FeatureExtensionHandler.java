 ...
 * <p>
 * Note that a {@link FeatureExtensionHandler} is <emphasis>only called for
 * features with a matching extension</emphasis> called and may only change the
 * feature bundles or feature configurations.
 */
@ConsumerType
